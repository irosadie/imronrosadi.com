...
const Contact: React.FC = () => {
  ...
  return (
    <div className="pt-40 pb-32 bg-[#050505] min-h-screen relative overflow-hidden">
      {/* Decorative Element */}
      <div className="glow bg-purple-600/10 w-[600px] h-[600px] bottom-0 -left-20 animate-float" style={{ animationDelay: '-3s' }}></div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-4xl mb-20">
            ...
            <p className="text-xl md:text-2xl text-white/50 leading-relaxed">
              {t(
                'Ready to initiate a high-impact digital project? Our team is available for deep technical consultations.',
                'Siap untuk memulai proyek digital berdampak tinggi? Tim kami tersedia untuk konsultasi teknis yang mendalam.'
              )}
            </p>
          </div>

          {/* Contact Cards - "Kontak Jelas" */}
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            ...
            <div className="glass-card p-12 rounded-[3.5rem] group">
              ...
              <h4 className="text-white font-black text-xl mb-4 uppercase tracking-widest">Headquarters</h4>
              <p className="text-white/40 mb-6">{t('Official engineering hub.', 'Pusat engineering resmi.')}</p>
              <span className="text-white font-bold text-lg leading-tight">{contact.address}</span>
            </div>
          </div>

          {/* Map Link / Placeholder */}
          <div className="rounded-[4rem] overflow-hidden border border-white/5 h-64 md:h-96 relative group cursor-pointer">
             <div className="absolute inset-0 bg-[#080808] flex items-center justify-center">
                <div className="text-center group-hover:scale-110 transition-transform duration-700">
                    <span className="text-white font-black text-xl uppercase tracking-[0.3em]">{t('Open in Google Maps', 'Buka di Google Maps')}</span>
                    <div className="w-20 h-[1px] bg-blue-500 mx-auto mt-4"></div>
                </div>
             </div>
             {/* Note: An iframe could be added here for a real map */}
          </div>
        </div>
      </div>
    </div>
